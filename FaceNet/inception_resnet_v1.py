...
class InceptionResnetV1(nn.Module):
    ...
    def __init__(self, pretrained=None, classify=False, num_classes=None, dropout_prob=0.6, device=None):
        ...
        if self.num_classes is not None:
            ...
            #print("1",self.logits.weight)
            nn.init.xavier_uniform_(self.logits.weight, gain=nn.init.calculate_gain('relu'))
            #nn.init.xavier_uniform_(self.logits.bias, gain=nn.init.calculate_gain('relu'))
            #print("2",self.logits.weight)
